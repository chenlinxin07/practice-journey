package lowerpart.myreflect.myreflect2;
...
public class MyReflectDemo {
    ...
    */
     static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
         //获取字节码文件
         Class clazz = Class.forName("lowerpart.myreflect.myreflect2.Student");
...
//         System.out.println(con5);
         ...
         System.out.println(modifiers);//public 1 ,private 2
         ...
         //暴力反射：表示临时取消权限校验
         con6.setAccessible(true);//如果不加这句,那private修饰的构造方法将不能被使用来创建对象
         Student stu = (Student) con6.newInstance("张三", 23);
