package lowerpart.myio.puzzlegame.src.com.ui;

import cn.hutool.core.io.FileUtil;

import com.util.CodeUtil;
import lowerpart.myio.puzzlegame.src.com.domain.User;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    private void readUserInfo() {
        //1.读取数据
        List<String> userInfoStrList = FileUtil.readUtf8Lines("E:\\Java\\practice-journey\\daily\\src\\lowerpart\\myio\\puzzlegame\\userinfo.txt");
        //2.遍历集合获取用户信息并创建User对象
        for(String s : userInfoStrList){
            String[] usarr = s.split("&");
            String[] name = usarr[0].split("=");
            String[] password = usarr[1].split("=");
            User u = new User(name[1],password[1]);
            allUsers.add(u);
        }
