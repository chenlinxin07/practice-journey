...
public class Test2_FabricateFalseData_hutool {
    void main(String[] args) {
        ...
        //6.写出数据
        //细节：
        //Hutool 的 FileUtil.writeLines 方法，相对路径的基准是「项目根目录」
        //（也就是你的 practice-journey 文件夹，IDEA 里运行时的 user.dir），不是 class 文件目录。
        //只有用 Class.getResource() 这类方法时，路径才会相对于 class 文件。
        String filePath = "src/lowerpart/myio/names.txt";
        FileUtil.writeLines(list, filePath, "UTF-8");
    }
