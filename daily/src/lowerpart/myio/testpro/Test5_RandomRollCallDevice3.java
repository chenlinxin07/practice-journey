...
public class Test5_RandomRollCallDevice3 {
    static void main(String[] args) throws IOException {
        ...
        */
        ...
        BufferedReader br1 = new BufferedReader(new FileReader("daily/src/lowerpart/myio/names.txt"));
        String line;
        ...
        br1.close();
        //2.读取当前程序已经运行的次数
        BufferedReader br2 = new BufferedReader(new FileReader("daily/src/lowerpart/myio/count.txt"));
